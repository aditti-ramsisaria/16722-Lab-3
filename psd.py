...
unmodulated_data = np.genfromtxt('unmodulated_noise.csv', delimiter=',', skip_header=1)
carrier_data = np.genfromtxt('no_noise.csv', delimiter=',', skip_header=1)  
modulated_data = np.genfromtxt('modulated_noise.csv', delimiter=',', skip_header=1)  

time_signal = carrier_data[1:400, 0] 
carrier_signal = carrier_data[1:400, 1] 
modulated_signal = modulated_data[1:400, 1] 
unmodulated_signal = unmodulated_data[1:400, 1] 
...
# Plot Raw Signal over Time - Dataset 1
plt.figure(figsize=(10, 4))
plt.plot(time_signal, unmodulated_signal, label='Unmodulated LUX Signal')
plt.legend()
plt.title('Dataset 1 - Unmodulated LUX Signal (with Noise) over Time')
plt.xlabel('Time')
...
# Plot Raw Signal over Time - Dataset 2
plt.figure(figsize=(10, 4))
plt.plot(time_signal, modulated_signal, label='Modulated LUX Signal')
plt.legend()
plt.title('Dataset 2 - Modulated LUX Signal (with Noise) over Time')
plt.xlabel('Time')
plt.ylabel('Signal Amplitude')
plt.grid(True)
plt.legend()
...
# Plot Raw Signal over Time - Inputs to Dataset 3
plt.figure(figsize=(10, 4))
plt.plot(time_signal, carrier_signal, label='Carrier Signal')
plt.plot(time_signal, modulated_signal, label='Modulated Signal')
plt.legend()
...
plt.legend()
plt.title('Dataset 3 - PSD LUX Signal over Time')
plt.xlabel('Time')
plt.ylabel('Signal Amplitude')
plt.grid(True)
plt.legend()
